...
class SetVariableSpeed(SetSpeed):
    ...
    def __init__(self, josh: subsystems.shooter._josh.Josh, speed_supplier: typing.Callable[[], float], PID_controller: wpimath.controller.PIDController, feedforward_constants, tolerance_constants) -> None:
